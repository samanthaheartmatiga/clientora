...
export default function MeetingGrid({
  ...
  const handleInitiateDelete = (meeting: Meeting) => {
  ...
  return (
    <>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <PermissionGuard module="meetings" action="delete">
                    <button
                      ...
                      suppressHydrationWarning
                      onClick={() => handleInitiateDelete(m)}
      ...
      {/* THEMED CENTERED DELETE MODAL (MOBILE & DESKTOP CENTERED) */}
      {meetingToDelete && (
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl max-w-sm w-full p-5 sm:p-6 text-center space-y-4 mx-auto my-auto transform transition-all scale-100">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <button
                ...
                className="w-full py-2.5 text-xs font-semibold rounded-xl bg-rose-600 hover:bg-rose-500 text-white shadow-lg shadow-rose-600/20 transition cursor-pointer flex items-center justify-center space-x-1.5"
              >
                <Trash2 className="h-3.5 w-3.5" />
                <span>Delete</span>
              </button>
