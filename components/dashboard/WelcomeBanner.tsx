...
export default function WelcomeBanner({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-indigo-100/80 bg-linear-to-r from-indigo-50/90 via-purple-50/40 to-slate-50 p-6 md:p-8 shadow-sm transition-colors duration-300 dark:border-indigo-900/40 dark:from-[#1e1b4b] dark:via-[#0f172a] dark:to-[#020617] dark:shadow-2xl">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          <button
            ...
            className="inline-flex items-center space-x-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:shadow-indigo-500/25 transition-all duration-200 cursor-pointer active:scale-95"
          >
          ...
          <button
            ...
            className="inline-flex items-center space-x-1.5 bg-white/80 hover:bg-white text-slate-700 border border-slate-200/90 text-xs font-medium px-3.5 py-2.5 rounded-xl shadow-xs transition-all duration-200 cursor-pointer active:scale-95 dark:bg-white/10 dark:hover:bg-white/15 dark:text-white dark:border-white/10"
          >
